...
// The severity rollup + the "which findings count" rule live with the review
// domain (`reviews/severity.ts`) so the PR list and the agent cards share them.
export { rollupSeverities, type SeverityCounts } from '../reviews/severity.js';
